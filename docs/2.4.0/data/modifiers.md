...
title = 'Modifiers'
linkTitle = 'Modifiers'
description = 'Modifiers or powers are what give your suit most of its abilities. You can use them as intended or get more creative with them.'
weight = 0
draft = false
+++
...
You can have multiple of each modifier with different properties by giving the modifier a modifier id. To give a modifier an id you need distinguish it with a  `|` symbol followed by a unique identifier like shown below. You can set when each ability is used using the `ifModifierEnabled` function in your suit's data file.
